...
void help() {
	printf("             MIT License - open source project do what ever you want with this           \n");
	printf("§========================================================================================§\n");
	printf("§       ./FakeMicWavPlayer <wav file> [sink list|default] [source process binary|default]§\n");
	printf("§____________________________. .______________. .________________________________. ._____§\n");
	printf("	                     | |              | |                                | |\n");
	...
	printf("  https://github.com/SCOTT-HAMILTON/FakeMicWavPlayer#how-does-it-work            | |\n");
	...
	printf("                                                                                 | |\n");
	printf("                                                                                 | |\n");
	printf("         The binary name of the application you want to play the wav file to.    =_|\n");
